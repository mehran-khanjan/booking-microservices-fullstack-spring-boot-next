...
import com.example.bookingservice.property.CorsProperties;
            ...
            auth ->
                auth
                    ...
                    .requestMatchers(
                        ...
                        ApiRoutes.Booking.BOOKING_TS,
                        ApiRoutes.Booking.PAYMENT,
                        ApiRoutes.Booking.PAYMENT_TS)
                    .hasAnyAuthority(
                        ROLES.USER.getKeycloakRoleName(), ROLES.ADMIN.getKeycloakRoleName())
