...
/**
 * Unit tests for {@link GlobalExceptionHandler}. Each handler method is invoked directly (no Spring
 * context required) with a real or lightly-mocked exception to verify the resulting HTTP status and
 * that the response body carries a sensible message.
 */
class GlobalExceptionHandlerTest {
  ...
  /**
   * Minimal {@link jakarta.validation.Path} stub used only when no validator-produced path is
   * available.
   */
